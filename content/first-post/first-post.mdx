...
3. The path to `kitten.png` which needs to be bundled, is now understood to be `content/first-post/kitten.png`
4. `kitten.png` is copied to the Next.js public folder by `mdx-bundler`.
5. Finally, thanks to `mdx-bundler` the URL in the compiled `first-post` body is updated to the bundled, public path, `public/images/first-post/kitten.png`.
